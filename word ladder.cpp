...
void getWords(string &word1, string &word2) {
  while (true) {
    ...
    cout << "The entered words have not same length. Enter words of same length." << endl;
  }
}


void printWordLadder(string word1, string word2){    /*printWordLadder(word1, word2)    prints the 
